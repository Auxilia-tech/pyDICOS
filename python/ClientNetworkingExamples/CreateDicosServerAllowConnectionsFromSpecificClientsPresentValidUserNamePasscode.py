...
from pyDICOS import AuthenticationCallbackAllowConnectsFromSpecificClientsPresentValidUserNamePasscode
...
def main():
   ...
   authenticationcallback = AuthenticationCallbackAllowConnectsFromSpecificClientsPresentValidUserNamePasscode()
   server = DcsServer()
   server.SetPort(1000)
