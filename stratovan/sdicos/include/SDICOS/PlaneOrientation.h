...
///
//////////////////////////////////////////////////////////////////////////////
#ifndef _STRATOVAN_DICOS_PLANE_ORIENTATION_H_
#define _STRATOVAN_DICOS_PLANE_ORIENTATION_H_
...
/// \brief Implements Plane Orientation, a required single item sequence (0020, 9116)
/// SPECREF V03 Section 14.14.4, Table 114
///
class PlaneOrientation
{
public:
	...
	PlaneOrientation();
	/// Copy constructor
	PlaneOrientation(const PlaneOrientation &planeorientation);
	/// Destructor
	virtual ~PlaneOrientation();

	/// Reset to default values
	void FreeMemory();

	/// Copy operator
	PlaneOrientation& operator=(const PlaneOrientation &planeorientation);
	/// Comparison operator
	bool operator==(const PlaneOrientation &planeorientation)const;
	/// Comparison operator
	bool operator!=(const PlaneOrientation &planeorientation)const;
