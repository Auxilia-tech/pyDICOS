...
///
//////////////////////////////////////////////////////////////////////////////
#ifndef _STRATOVAN_DICOS_TDR_H_
#define _STRATOVAN_DICOS_TDR_H_

#include "SDICOS/TDRSeries.h"
#include "SDICOS/GeneralReport.h"
#include "SDICOS/ThreatDetectionReport.h"
#include "SDICOS/AdditionalInspectionSelectionCriteria.h"
#include "SDICOS/ThreatSequence.h"
...
///
/// \class TDRModule
/// \brief Implements Threat Detection Report (TDR) Information Object Definition (IOD)
/// SPECREF V03 Section 12, Table 65
///
/// Note: This class is not thread safe
/// DICOS SOP Class Name and UID:
///		Name:	"DICOS Thread Detection Report (TDR) Storage"
///		UID:	"1.2.840.10008.5.1.4.1.1.501.3"
///
class TDRModule : public ScannerCommon
{
public:
	/// Constructor
	TDRModule();
	/// Copy constructor
	TDRModule(const TDRModule &tdr);
	/// Destructor
	~TDRModule();
	...
	/// Copy operator
	TDRModule& operator=(const TDRModule &tdr);
	/// Comparison operator
	bool operator==(const TDRModule &tdr)const;
	/// Comparison operator
	bool operator!=(const TDRModule &tdr)const;
	...
	/// TDR Series [required]
	bool SetSeries(const TDRTypes::TDRSeries &series);
	/// @see SetSeries
	bool GetSeries(TDRTypes::TDRSeries &series)const;
	/// @see SetSeries
	TDRTypes::TDRSeries& GetSeries();
	/// @see SetSeries
	const TDRTypes::TDRSeries& GetSeries()const;
	...
	/// General Report [required]
	bool SetGeneralReport(const TDRTypes::GeneralReport &report);
	/// @see SetGeneralReport
	bool GetGeneralReport(TDRTypes::GeneralReport &report)const;
	/// @see SetGeneralReport
	TDRTypes::GeneralReport& GetGeneralReport();
	/// @see SetGeneralReport
	const TDRTypes::GeneralReport& GetGeneralReport()const;

	/// Threat Detection Report [required]
	bool SetThreatDetectionReport(const TDRTypes::ThreatDetectionReport &report);
	/// @see SetThreatDetectionReport
	bool GetThreatDetectionReport(TDRTypes::ThreatDetectionReport &report)const;
	/// @see SetThreatDetectionReport
	TDRTypes::ThreatDetectionReport& GetThreatDetectionReport();
	/// @see SetThreatDetectionReport
	const TDRTypes::ThreatDetectionReport& GetThreatDetectionReport()const;

	/// Additional Inspection Selection Criteria Module [required]
	bool SetAdditionalInspectionSelectionCriteria(const TDRTypes::AdditionalInspectionSelectionCriteria &aisc);
	/// @see SetAdditionalInspectionSelectionCriteria
	bool GetAdditionalInspectionSelectionCriteria(TDRTypes::AdditionalInspectionSelectionCriteria &aisc)const;
	/// @see SetAdditionalInspectionSelectionCriteria
	TDRTypes::AdditionalInspectionSelectionCriteria& GetAdditionalInspectionSelectionCriteria();
	/// @see SetAdditionalInspectionSelectionCriteria
	const TDRTypes::AdditionalInspectionSelectionCriteria& GetAdditionalInspectionSelectionCriteria()const;

	/// Threat Sequence [required]
	bool SetThreatSequence(const TDRTypes::ThreatSequence &threatsequence);
	/// @see SetThreatSequence
	bool GetThreatSequence(TDRTypes::ThreatSequence &threatsequence)const;
	/// @see SetThreatSequence
	TDRTypes::ThreatSequence& GetThreatSequence();
	/// @see SetThreatSequence
	const TDRTypes::ThreatSequence& GetThreatSequence()const;
