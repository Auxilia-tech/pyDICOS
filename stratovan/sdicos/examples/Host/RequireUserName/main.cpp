...
//////////////////////////////////////////////////////////////////////////////
//
// This example configures a server to require all clients to present a valid user name
//
...
{
protected:
	/// Override to verify user name. Return true if the user name is accepted. Return false if user name is rejected.
...
int main()
{
	...
	// Configure server to only allow clients with the following user names.
	// The allowed application names are defined in the derived 
	// function ApplicationNameVerificationCallback::OnIsUserNameValid()
...
bool AuthenticationCallback::OnIsUserNameValid(const SDICOS::DcsString &dsUserName)const
{
