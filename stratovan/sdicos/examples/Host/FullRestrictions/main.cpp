...
//////////////////////////////////////////////////////////////////////////////
//
// This example configures a server to only allow connections from specific client applications and
// require those clients to present a valid user name and passcode
//
...
int main()
{
	...
	// Require client application names. The allowed application names are defined in 
	// the derived function ApplicationNameVerificationCallback::OnAuthenticateClientApplicationName()
	...
	// function ApplicationNameVerificationCallback::OnAuthenticateUserNameAndPasscode()
...
bool AuthenticationCallback::OnAuthenticateClientApplicationName(const SDICOS::Utils::AuthenticationData &ad)const
{
	return	ad.m_dsClientAppName == SDICOS::DcsString("ClientAppA") ||
			ad.m_dsClientAppName == SDICOS::DcsString("ClientAppB") ||
			ad.m_dsClientAppName == SDICOS::DcsString("ClientAppC") ||
			ad.m_dsClientAppName == SDICOS::DcsString("ClientAppD");
}
