...
///
//////////////////////////////////////////////////////////////////////////////
// StartUserLevelWithCustomMemoryManager
//
// This example shows how to use IMemoryManager to provide memory allocation and 
// deallocation for the DICOS library's when loading with User-Level API.
//
...
int main()
{
	...
	//AIT 2D
	{
		SDICOS::AIT2D ait;	//Modality to load
		SDICOS::Filename filename("../DataFiles/V03_Data/AIT2DwithTDR/ait2d.dcs"); //Set this to a valid file
	...
	//AIT 3D
	{
		SDICOS::AIT3D ait;	//Modality to load
		SDICOS::Filename filename("../DataFiles/V03_Data/AIT3D_RHS/ait3d_RHS.dcs"); //Set this to a valid file
		SDICOS::ErrorLog errorlog; //Error log for loading data
	...
	//DX
	{
		SDICOS::DX dx;	//Modality to load
		SDICOS::Filename filename("../DataFiles/V03_Data/DXwithTDR/dx.dcs"); //Set this to a valid file
		SDICOS::ErrorLog errorlog; //Error log for loading data
...
// EndUserLevelWithCustomMemoryManager
