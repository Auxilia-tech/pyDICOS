...
//////////////////////////////////////////////////////////////////////////////
//
// This example shows how to manually connect to a server, start a DICOS session, then send a C-Echo.
//
...
int main()
{
	...
	//Manually start a DICOS session to allow processing C-Echo commands.
