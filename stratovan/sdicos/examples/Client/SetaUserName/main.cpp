...
//////////////////////////////////////////////////////////////////////////////
//
// This example configures a client to have a user name
//
...
int main()
{
	...
	// Set a user name for the client. User name can also be set
	...
	//An invalid user name can cause a DICOS session to not start.
