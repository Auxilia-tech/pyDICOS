	...
	*/
	{
		/*
		*
		* Frame of Reference attributes now are inherited from SDICOS::FrameOfReferenceUser instead of being direct members of SDICOS::CT
		*
		...
		*/
		{
			// Previous:
			// const DcsString& SDICOS::CT::GetFrameOfReferenceUID() const;
			// Updated:
