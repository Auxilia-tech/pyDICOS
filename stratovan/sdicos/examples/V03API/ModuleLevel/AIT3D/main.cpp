	...
	*/
	{
		...
		* SetImageTypeAIT3D now accepts four arguments to accommodate the value for Image Characteristics
		* GetImageTypeAIT3D now accepts four arguments to accommodate the value for Image Characteristics
		*/
		...
		//Old Call:
		//image.SetImageTypeAIT3D(nPixelDataCharacteristics, nImageFlavor, nDerivedPixelContrast);

		//New Call:
		image.SetImageTypeAIT3D(nPixelDataCharacteristics, nImageCharacteristics, nImageFlavor, nDerivedPixelContrast);

		/// GetImageTypeAIT3D
		SDICOS::DcsString strPixelDataCharacteristics, strImageCharacteristics, strImageFlavor, strDerivedPixelContrast;

		//Old Calls:
		//image.GetImageTypeAIT3D(nPixelDataCharacteristics, nImageFlavor, nDerivedPixelConstrast);
		//image.GetImageTypeAIT3D(strPixelDataCharacteristics, strImageFlavor, strDerivedPixelContrast);
		
		//New Calls:
		image.GetImageTypeAIT3D(nPixelDataCharacteristics, nImageCharacteristics, nImageFlavor, nDerivedPixelContrast);
		image.GetImageTypeAIT3D(strPixelDataCharacteristics, strImageCharacteristics, strImageFlavor, strDerivedPixelContrast);
	}
