...
def main():
    ...
    if client.StartDicosSession(DcsClient.SOPCLASSUID.enumSopEcho | 
                                ...
                                DcsClient.SOPCLASSUID.enumSopTDR) == True:
    ...
    if client.StartDicosSession(DcsClient.SOPCLASSUID.enumSopDX | 
                                DcsClient.SOPCLASSUID.enumSopTDR) == True:
        ...
        print("Error log:")
        print(client.GetErrorLog().GetErrorLog().Get())
        client.GetErrorLog().WriteLog(Filename("ErrorLog - DICOS Session 2 Start Failed.txt"))
        return 1
